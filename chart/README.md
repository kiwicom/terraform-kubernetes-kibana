...
| `extraVolumes`            | Templatable string of additional volumes to be passsed to the tpl function                                                                                                                                                                                                                                                                                     | `""`
...
| `commonAnnotations`       | Common annotations for all the resources                                                                                                                                                                                                                                                                                                                       | `{}`                                                                                                                      |
